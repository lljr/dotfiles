...
#+BEGIN_SRC emacs-lisp
  ...
  (add-to-list 'exec-path "~/.nvm/versions/node/v14.17.6/bin/")
...
*** Rainbow Delimiters
 ...
 #+end_src
* Packages
** Vertico / CtrlF / Marginalia / Consult
...
#+begin_src emacs-lisp
  (with-eval-after-load 'yasnippet
    ...
    (yas-reload-all)
    ;; TODO Programatically create "snippets" directory,
    ;; snippet's modes and
    ;; append snippet content
    ;; do this on first install

    ;; `make-directory' singals an error so we use condition-case
    ;; to handle it
    ;; (condition-case nil


    ;;     (if (= (concat (getenv "HOME") ".emacs.d/")
    ;;            (file-name-directory (or load-file-name (buffer-file-name))))
    ;;         (progn
    ;;           (make-directory "snippets/js-mode" t)
    ;;           )
    ;;       (message "Error creating Yasnippets directory: Incorrect directory.")
    ;;      )
        )
#+end_src
...
*** Javascript
  #+begin_src emacs-lisp
    ...
    (with-eval-after-load 'js
      ...
      (define-key js-mode-map (kbd "C-c C-f") 'sgml-skip-tag-forward)
      (define-key js-mode-map (kbd "C-c C-b") 'sgml-skip-tag-backward)
      (define-key js-mode-map (kbd "C-c C-k") 'sgml-delete-tag))
